...
[1] Deepak Pathak, Philipp Kr&auml;henb&uuml;hl, Jeff Donahue, Trevor Darrell, and Alexei A. Efros.
Context encoders: Feature learning by inpainting. CoRR, abs/1604.07379, 2016.

[2] Satoshi Iizuka, Edgar Simo-Serra, and Hiroshi Ishikawa. Globally and locally consistent
image completion. ACM Trans. Graph., 36(4), 2017.

[3] Jiahui Yu, Zhe Lin, Jimei Yang, Xiaohui Shen, Xin Lu, and Thomas S. Huang. Generative
...
[4] Kamyar Nazeri, Eric Ng, Tony Joseph, Faisal Qureshi, and Mehran Ebrahimi. Edge-
...
[5] Qianna Wang, Yi Chen, Nan Zhang, and Yanhui Gu. Medical image inpainting with
edge and structure priors. Measurement: Journal of the International Measurement
Confederation, 185, 2021.

[6] Lan Lan, Lei You, Zeyang Zhang, Zhiwei Fan, Weiling Zhao, Nianyin Zeng, Yidong Chen,
and Xiaobo Zhou. Generative adversarial networks and its applications in biomedical
informatics, 2020.

[7] Michela Antonelli, Annika Reinke, Spyridon Bakas, Keyvan Farahani, Annette Kopp-
...
[8] The Cancer Imaging Archive. The Cancer Imaging Archive (TCIA), 2024.
