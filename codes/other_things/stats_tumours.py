...
complexity_names = ['Without Tumour','With Tumour','All']
    ...
    for mask_percentage in [10,20,30,40]:
        ...
        for i in range(10):
            try:
                ...
                NON_TUMOR_MAE.append(np.mean(data[0][2]))
                TUMOR_MAE.append(np.mean(data[0][1]))
                
                MSE.append(np.mean(data[1][0]))
                NON_TUMOR_MSE.append(np.mean(data[1][2]))
                TUMOR_MSE.append(np.mean(data[1][1]))

                PSNR.append(np.mean(data[2][0]))
                NON_TUMOR_PSNR.append(np.mean(data[2][2]))
                TUMOR_PSNR.append(np.mean(data[2][1]))

                SSIM.append(np.mean(data[3][0]))
                NON_TUMOR_SSIM.append(np.mean(data[3][2]))
                TUMOR_SSIM.append(np.mean(data[3][1]))

                FID.append(data[4][0].numpy())
                NON_TUMOR_FID.append(data[4][2].numpy())
                TUMOR_FID.append(data[4][1].numpy())
...
with pd.ExcelWriter("STATISTICS_TUMOUR.xlsx", engine='openpyxl') as writer:
